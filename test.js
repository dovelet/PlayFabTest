...
handlers.setPlayerLanguageBak = function(args)
{
    var request = {
        PlayFabId: currentPlayerId,
        Data: {
...
handlers.getServerStatus =  function(args)
{
    //테스트 
    var datas = server.GetTitleData({
        Keys : "balance_KR"
...
function savePlayerData(args)
{
    var playerId = currentPlayerId;
    
}

handlers.testValue = function(args,content)
{
    var data = [{"id":1, "a":3333333333331},{"id":2, "b":2}];
    return data.find(x=>x.id == 1).a;
}
